        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="contact-left md:w-1/3">
            ...
            <div className="social-icons mt-8 flex space-x-4">
              <a href="https://www.instagram.com/ishaann.ai/" target="_blank" rel="noopener noreferrer" className="text-dark-text text-3xl transition-transform duration-300 hover:text-brand-teal-hover hover:-translate-y-1">
                <FontAwesomeIcon icon={faInstagram} />
              </a>
              <a href="https://www.linkedin.com/in/ishaan7/" target="_blank" rel="noopener noreferrer" className="text-dark-text text-3xl transition-transform duration-300 hover:text-brand-teal-hover hover:-translate-y-1">
              ...
              <a href="https://x.com/ishaankatara" target="_blank" rel="noopener noreferrer" className="text-dark-text text-3xl transition-transform duration-300 hover:text-brand-teal-hover hover:-translate-y-1">
