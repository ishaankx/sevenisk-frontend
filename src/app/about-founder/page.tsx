...
      // --- ⭐️ FIX: Use the CSS ranges for consistency and manage the float here ---
      // We now rely on the CSS/Tailwind for positioning the snippet-host element.
      // The float range here controls how far the *snippets* are scattered from the center (50% 50%).
      const floatRangeX = isMobile ? [-120, 120] : [-250, 250]; // Increased desktop range
      const floatRangeY = isMobile ? [-120, 120] : [-250, 250]; // Increased desktop range
      // --- End of FIX ---
...
        // --- ⭐️ FIX: Tighter float animation is correct here, but range updated above ---
        gsap.to(snippet, {
